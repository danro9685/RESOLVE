...
#' a background signature during the inference step and adopts elastic net regression to reduce the impact of overfitting. 
#' The estimation of the optimal number of signatures is performed by bi-cross-validation.
#' 
